...
class AlbumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create album" do
    assert_difference('Album.count') do
      post albums_url, params: { album: { album_date: @album.album_date, name: @album.name } }
    end
  ...
  test "should update album" do
    patch album_url(@album), params: { album: { album_date: @album.album_date, name: @album.name } }
